...
/**
 * Script de génération automatique de contrats simplifié
 * Fonctionne sans CRON_SECRET - utilise une URL secrète
 * 
 * Usage:
 * - En développement: node scripts/auto-generate-simple.js
...
// Configuration
const CONFIG = {
  // URL de l'API de génération (avec secret intégré)
  apiUrl: process.env.NODE_ENV === 'production' 
    ? 'https://fixer.rancune.games/api/crons/generate-contracts-secret/nightcity-auto-2024-secret'
    : 'http://localhost:3000/api/crons/generate-contracts-secret/nightcity-auto-2024-secret',
